...
comment1 = Comment.create!(body: "dwjf jog3ij4t9-2 mfeprgojp'3 ojgpo jnjro3jigp42jgpn jp24jgp23gjn ", post: post1)
comment2 = Comment.create!(body: "9ur0g9u09n jor3ijog j039u9g 949j0940gj0439utj 0njg09rj30gnj03u9gnvj3", post: post2)
comment3 = Comment.create!(body: "r3g nor3jg o3ji0gj ngojpo3jgo jo3ijogj09gjonmjgorijg no oirjgoi3joj j oiejogijo  oijrgoij3ojgo3jg", post: post3)
comment4 = Comment.create!(body: "rgjo4jrnp[ bj5goi j5o;4ijgoj9", post: post4)
comment5 = Comment.create!(body: "geihjrgorvvvoirjgo3ijo ijgo3ijgo ij3oj4ot9", post: post5)
comment6 = Comment.create!(body: "rg35g       3vfejvore ij oj9gj54bjoej9p9jgpe9jg9o 9urg 9uoejboq;ghh'ajga'jopekperokjgpoekpojovnouwhubunkjnviotjot4jg ngleirjgo43jo9uj4gvnqigno;riot49", post: post5)